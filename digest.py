...
2. Каждой теме поставь score от 0 до 10 по силе влияния именно на этого человека.
   ...
   4-5 фон, 0-3 шум.
3. Title должен нести саму суть события с конкретикой (что произошло, с кем,
   какие числа). Пояснений, зачем это читателю, не нужно: он поймёт сам.
